...
mariadb --database $MARIADB_DB --user $MARIADB_USER --port $MARIADB_PORT -p$MARIADB_PASSWORD < $cwd/employeur_assures.sql
...
rm -rf $cwd/employeur_assures.sql
rm -rf $cwd/beneficiaires.sql
